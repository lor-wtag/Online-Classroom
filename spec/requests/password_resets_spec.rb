...
RSpec.describe "PasswordResets", type: :request do
  ...
  describe "POST /password_reset" do
    ...
    context "with invalid email" do
      it "does not send a password reset email" do
        ...
        expect(response.body).to include("Email not found") # Modify based on your actual error handling
      end
    end
  end
  ...
  describe "GET /password_reset/edit" do
    it "renders the edit page with valid token" do
      ...
      expect(response.body).to include("Reset your password") # Adjust according to your view content
    end
